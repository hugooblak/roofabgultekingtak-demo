...
add_filter(
	...
	function ( $exporters ) {
		$exporters['roofabgultekingtak-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'roofabgultekingtak-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'roofabgultekingtak-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'roofabgultekingtak-leads',
						'group_label' => __( 'Quote requests', 'roofabgultekingtak-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['roofabgultekingtak-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'roofabgultekingtak-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
