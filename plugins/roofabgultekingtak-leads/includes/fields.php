...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'roofabgultekingtak-leads' ),
				'storm'       => __( 'Storm or hail damage', 'roofabgultekingtak-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'roofabgultekingtak-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'roofabgultekingtak-leads' ),
				'not-sure'    => __( 'Vet inte än', 'roofabgultekingtak-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'roofabgultekingtak-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'roofabgultekingtak-leads' ),
				'research' => __( 'Jag kollar bara priser', 'roofabgultekingtak-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'roofabgultekingtak-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'roofabgultekingtak-leads' ),
		'contacted' => __( 'Kontaktad', 'roofabgultekingtak-leads' ),
		'quoted'    => __( 'Quote sent', 'roofabgultekingtak-leads' ),
		'won'       => __( 'Won', 'roofabgultekingtak-leads' ),
		'lost'      => __( 'Lost', 'roofabgultekingtak-leads' ),
		'spam'      => __( 'Misstänkt spam', 'roofabgultekingtak-leads' ),
	);
}
