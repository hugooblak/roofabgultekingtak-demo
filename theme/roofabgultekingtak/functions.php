<?php
/**
 * Roofab Gulteking Tak AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Roofab Gulteking Tak AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through ro_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'roofabgultekingtak', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'roofabgultekingtak' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'roofabgultekingtak' ) ) );

		register_block_pattern_category( 'roofabgultekingtak-sections', array( 'label' => __( 'Roofab Gulteking Tak AB sections', 'roofabgultekingtak' ) ) );
		register_block_pattern_category( 'roofabgultekingtak-pages', array( 'label' => __( 'Roofab Gulteking Tak AB page layouts', 'roofabgultekingtak' ) ) );
	}
);
